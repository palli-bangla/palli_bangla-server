...
const getReviews = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const message = (result === null || result === void 0 ? void 0 : result.length) === 0 ? "This user does not have any Review" : 'Review Retrived successfully!';
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message,
...
const updateReview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield review_service_1.ReviewService.updateReview(ReviewId, updatedReviewData);
